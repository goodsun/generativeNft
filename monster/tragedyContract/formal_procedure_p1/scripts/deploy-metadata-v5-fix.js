...
async function main() {
  ...
  console.log("Using ComposerV5:", deployment.contracts.composerV5);

  // Deploy fixed TragedyMetadataV5
  ...
  console.log("TragedyMetadataV5 (fixed interfaces) deployed to:", metadataV5Address);
