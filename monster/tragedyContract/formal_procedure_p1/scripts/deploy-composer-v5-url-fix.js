...
async function main() {
  ...
  // Deploy ArweaveTragedyComposerV5 with URL support
  ...
  console.log("ArweaveTragedyComposerV5 (URL support) deployed to:", composerV5Address);
  ...
  deployment.note = "V5 system with URL support for Background/Effect";
